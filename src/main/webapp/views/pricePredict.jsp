        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li><a href="priceTend" ><i class="fa fa-desktop"></i>
                    价格走势图</a></li>
                <li><a href="#" class="active-menu"><i class="fa fa-bar-chart-o"></i>
                    价格预测图</a></li>
                            ...
                            <div class="panel-heading">
                                <div class="panel-heading">
                                    ...
                                    <select id="choose-trend" onchange="trendChange()">
                                        <option value="1">周趋势</option>
                                        <option value="2">月趋势</option>
                                        <option value="3">年趋势</option>
                                    </select>
...
<script type="text/javascript">
    ...
    function queryTrend() {
        ...
        var url = 'getPricePredictByWeek';

        if(window.trend=='2'){
            url = 'getPricePredictByMonth';

        }
        if(window.trend=='3'){
            url = 'getPricePredictByYear';
        }
        $.ajax({  // ajax登陆请求
            url:url,
            type:"post",
            ...
            success:function(res){
                ...
                for(var i=0;i<trend.length;i++){
                    values.push(trend[i].toFixed(2));
                }
                var myChart = echarts.init(document.getElementById('price-trend'));
                /* console.log(jsonObj.day1); */
                var tt = '一周内';
                var keys = ['05-15','05-16','05-17','05-18','05-19','05-20','05-21'];
                if(window.trend=='2'){
                    keys = ['05-15','05-18','05-21','05-24','05-27','05-30','06-02'];
                    tt = '一月内';
                }
                if(window.trend=='3'){
                    keys = ['6月','7月','8月','9月','10月','11月','12月'];
                    tt = '当年';
                }
                option = {
                    title : {
                        text: window.type+tt+window.title+'价格预测',
                    },
                    tooltip : {
                        trigger: 'axis'
                    },
